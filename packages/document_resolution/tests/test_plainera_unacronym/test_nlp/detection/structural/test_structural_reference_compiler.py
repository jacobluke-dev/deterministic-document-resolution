...
class TestCompileStructuralReferencePatterns:
    def test_compile_structural_reference_patterns_returns_patterns_container(self):
        out = compile_structural_reference_patterns()

        assert isinstance(out, StructuralReferencePatterns)

    def test_compile_structural_reference_patterns_matches_schedule_alpha(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_matches_schedule_numeric(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_matches_exhibit_reference(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_matches_annex_reference(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_matches_appendix_reference(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_matches_section_decimal(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_matches_clause_decimal(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_matches_article_roman(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_matches_article_numeric(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_ignores_plain_capitalised_phrase(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_is_case_insensitive_for_kind(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_matches_appendix_alpha_decimal(self):
        patterns = compile_structural_reference_patterns()
    ...
    def test_compile_structural_reference_patterns_matches_appendix_alpha_multi_decimal(self):
        patterns = compile_structural_reference_patterns()
