...
from document_resolution.nlp.detection.structural.detector import StructuralReferenceDetector
...
from document_resolution.nlp.extraction.structural.link import build_structural_reference_links
from document_resolution.nlp.extraction.structural.state import StructuralFlowState
from document_resolution.nlp.extraction.structural.transform import (
