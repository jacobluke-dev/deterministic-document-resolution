...
from document_resolution.nlp.common.constants_regex import ALLOW_CHARS, DottedMode

if TYPE_CHECKING:
    from document_resolution.nlp.extraction.tiers.types import Tier2OccurrenceRanking, Tier2Report
