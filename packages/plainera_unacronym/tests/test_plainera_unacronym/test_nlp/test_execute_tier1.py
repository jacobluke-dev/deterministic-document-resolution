...
class TestDetectAndExtractIntegration:
    ...
    def test_mixed_forward_reverse_inline_and_confidence(self, picked_def):
        text = (
...
class TestDetectAndExtractIntegrationEdgeCases:
    def test_forward_parenthetical_does_not_span_newlines_and_keeps_pto(self, picked_def):
    ...
    def test_inline_long_tail_is_gated_by_max_phrase_chars_30(self, picked_def):
    ...
    def test_special_char_acronym_and_bridges(self, picked_def):
    ...
    def test_ambiguous_acronym_builds_multiple_senses(self, picked_def):
    ...
    def test_nearest_pick_prefers_definition_near_first_occurrence(self, picked_def):
