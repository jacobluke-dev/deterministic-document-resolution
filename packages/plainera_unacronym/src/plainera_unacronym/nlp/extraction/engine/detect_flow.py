...
class ExtractionFlow:
    ...
    def build_chain(self) -> Chain[FlowState]:
        ...
        return Chain([
            ...
            Stage("anchored_first_occurrence_picks",
                  lambda s: f.st_anchored_first_occurrence_picks(s, window_left=wl, window_right=wr),
            ...
            Stage("harvest_defs_all_occurrences",
                  f.st_harvest_defs_all_occurrences,
