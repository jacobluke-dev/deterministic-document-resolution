...
from plainera_unacronym.nlp.common.types import OccurrenceBuildError, DetectorConfig
...
def score_chunk_worker(cfg: DetectorConfig, text: str, cands: list[tuple[str, int, int]]) -> list[Occurrence]:
    """
