...
# from .acronym.chunking import score_chunk_worker
# from .acronym.compiler import compile_acronym_pattern
#
...
# from .nlp_helpers import cfg_fingerprint, top_n_values
#
...
#         self.cfg = config
#         self._pat = compile_acronym_pattern(config)  # precompiled once
...
#             futures.append(self._pool.submit(score_chunk_worker, cfg, text, cands[i: i + chunk_size]))
#
#         occurrences: list[Occurrence] = []
