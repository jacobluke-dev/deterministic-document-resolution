...
from document_resolution.nlp.common.types import AcronymDetectorConfig, AcronymPipelineResult
...
from document_resolution.orchestration import PIPELINE_ACRONYMS, PipelineRegistry, PipelineRunResult
from document_resolution.orchestration.interface import OrchestrationRequest
