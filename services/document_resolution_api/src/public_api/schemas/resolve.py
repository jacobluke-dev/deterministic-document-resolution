...
from document_resolution.orchestration.state import PipelineErrorCode
...
class ResolveMeta(BaseSchema):
    processing_ms: int
    model_version: str = Field(..., description="document-resolution-core version used for processing.")
    input_chars: int
